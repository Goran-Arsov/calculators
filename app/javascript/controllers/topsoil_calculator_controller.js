...
import { SQFT_TO_SQM, CUFT_TO_CUM, LB_TO_KG, FT_TO_M, IN_TO_CM } from "../utils/units"

const CUBIC_FEET_PER_YARD = 27.0
const POUNDS_PER_CUBIC_FOOT = 75.0
const BAG_CUBIC_FEET_40LB = 0.5
const IMPERIAL_DEFAULTS = { length: 10, width: 4, depth: 6 }
const METRIC_DEFAULTS = { length: 3, width: 1.2, depth: 15 }

export default class extends Controller {
  static targets = [
    "unitSystem", "length", "width", "depth",
    "lengthLabel", "widthLabel", "depthLabel",
    "resultCubicYards", "resultCubicFeet", "resultPounds", "resultBags", "resultArea"
  ]
