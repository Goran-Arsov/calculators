...
export default class extends Controller {
  ...
  addLineItem() {
    ...
    row.innerHTML = `
      ...
      <div class="grid grid-cols-3 gap-2 mb-2">
        <div>
          <label class="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Measure (piece, kg, cm3...)</label>
          ...
          <table class="w-full mb-6">
            <thead>
              <tr class="bg-gray-100 dark:bg-gray-800">
                ...
                <th class="py-2 px-2 text-center text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Measure (piece, kg, cm3...)</th>
  ...
  downloadPdf() {
    ...
    const tableRows = [["Item", "Code", "Measure", "Price", "Qty", "Tax", "w/ Tax", "Disc.", "Total"]]
    const rows = this.lineItemsTarget.querySelectorAll("[data-line-item]")
    let totalSubtotal = 0
    let totalTax = 0
    let totalDiscount = 0
