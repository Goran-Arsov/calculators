...
class RefactoredCalcsRenderTest < ActionDispatch::IntegrationTest
  REFACTORED = [
    ...
    [ :construction, %w[asphalt attic_ventilation baseboard bathroom_remodel beam_load_span board_foot brick_block cabinet_door carpet concrete concrete_mix deck drainage_slope drywall excavation fence flooring gravel_mulch grout gutter hvac_btu insulation kitchen_remodel lumber paint paver plumbing plywood_sheets pool_volume rafter_length rebar_spacing retaining_wall roof_pitch roofing septic_tank_size siding solar_panel_layout sqft_cost staircase stud_count tile wallpaper water_heater_sizing wood_moisture wood_shrinkage wood_weight] ],
