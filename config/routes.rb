Rails.application.routes.draw do
  ...
  get ":category", to: "categories#show", as: :category,
      constraints: { category: /finance|math|physics|health|construction|textile|everyday|alcohol|geography|gardening|relationships|photography|education|pets|cooking|automotive/ }
